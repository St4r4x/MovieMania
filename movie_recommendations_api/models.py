...
class Castings(Base):
    ...
    actor_name: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)  # Spécifier la longueur de la chaîne
...
class Crews(Base):
    ...
    person_name: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)  # Spécifier la longueur de la chaîne
...
class Users(Base):
    ...
    sexe: Mapped[Optional[str]] = mapped_column(String(10), nullable=True)  # Spécifier la longueur de la chaîne
