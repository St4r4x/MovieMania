        ...
        <>
          ...
          <div className="w-auto p-10 rounded-3xl bg-none sm:bg-gradient-to-b sm:from-[rgba(66,242,247,0.1)] sm:to-[rgba(255,255,255,0.1)]">
            <div className="mx-auto flex w-full flex-col justify-center space-y-6">
              ...
              <SigninForm onNextClick={handleNextClick} />
          ...
          <div className="flex flex-col gap-4">
            <div className="flex flex-row gap-5 items-center">
              <div className="rounded-full bg-white w-11 h-11 relative">
                <Image className="absolute start-1 top-1" src={Popcorn} alt="popcorn" width={35} height={35} />
              </div>
            ...
            <PreferencesForm onBackClick={handleBackClick} formData={formData} />
          </div>
        </>
      )}
    </main>
